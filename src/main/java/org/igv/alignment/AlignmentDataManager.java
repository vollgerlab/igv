...
public class AlignmentDataManager implements IGVEventObserver {
    ...
    public void setViewAsPairs(boolean option, RenderOptions renderOptions, Track.DisplayMode displayMode) {
     ...
     */
    void packAlignments(RenderOptions renderOptions, Track.DisplayMode displayMode) {
        for (AlignmentInterval interval : intervalCache) {
    ...
    AlignmentInterval loadInterval(String chr, int start, int end, RenderOptions renderOptions, ReferenceFrame frame) {
    ...
    public PackedAlignments getGroups(AlignmentInterval interval, RenderOptions renderOptions) {
    ...
    public void updatePEStats(RenderOptions renderOptions) {
